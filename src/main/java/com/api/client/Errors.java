...
public interface Errors {
	...
	String[] categories= {"should have required property 'name'"};
	String[] products= {"should have required property 'name'",
				      "should have required property 'type'",
				      "should have required property 'upc'",
				      "should have required property 'description'",
				      "should have required property 'model'"};
	String[] stores= { "should have required property 'name'",
